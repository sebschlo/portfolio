 ...
 * appear in real URIs.
 *
 * TODO(nicksantos): Remove this once people have time to fix all test.
 *
 * @type {boolean}
 */
...
goog.Uri.prototype.getParameterValue = function(paramName) {
  ...
  // But this should only be set to true in test.
...
goog.Uri.QueryData.prototype.set = function(key, value) {
  ...
  // end) and we would have to fix unit test that depend on key
  // ordering.
  key = this.getKeyName_(key);
