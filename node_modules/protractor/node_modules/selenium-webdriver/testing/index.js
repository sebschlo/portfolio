 ...
 * to simplify writing asynchronous test:
 * <pre><code>
...
function wrapped(globalFn) {
  ...
  function asyncTestFn(fn) {
    var ret = function(done) {
      ...
      this.timeout = undefined;  // Do not let test change the timeout.
      try {
 ...
 *     {@link #describe()} that ignore test as indicated by the predicate.
 */
