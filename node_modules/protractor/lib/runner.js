...
/**
 * Registrar for testPreparers - executed right before test run.
 * @public
...
Runner.prototype.setupGlobals_ = function(driver) {
  ...
  // Export protractor to the global namespace to be used in test.
 ...
 *
 * @return {q.Promise} A promise which resolves to the exit code of the test.
 * @public
 */
