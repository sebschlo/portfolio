...
var Protractor = function(webdriverInstance, opt_baseUrl, opt_rootElement) {
   ...
   * test to become flaky. This should be used only when necessary, such as
...
/**
 * Add the base mock modules used for all Protractor test.
 *
 * @private
 */
...
/**
 * Beta (unstable) pause function for debugging webdriver test. Use
