...
exports.config = {
  ...
  // The test will be run remotely using Sauce Labs.
  sauceUser: null,
  sauceKey: null,
  ...
  // ---------------------------------------------------------------------------
  //
  // Protractor can launch your test on one or more browsers. If you are
  ...
  // test, use multiCapabilities, which takes an array of capabilities.
  ...
  // A callback function called once test are finished.
  onComplete: function() {
    // At this point, test will be done but global objects will still be
    // available.
  },

  // A callback function called once the test have finished running and
  // the WebDriver instance has been shut down. It is passed the exit code
  // (0 if the test passed or 1 if not). This is called once per capability.
