...
[
  ...
  testcases.forEach(function (test) {
    // we are unable to parse these test atm because invalid JSON is used to
    // store the useragents
    if (typeof test.user_agent_string !== 'string') return;

    // these test suck as the test files are broken, enable this to have about
    // 40 more failing test
