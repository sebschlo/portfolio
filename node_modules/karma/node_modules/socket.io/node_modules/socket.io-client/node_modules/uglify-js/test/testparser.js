...
function ParserTestSuite(callback){
	var inps = [
		...
		// http://code.google.com/p/es-lab/source/browse/trunk/test/parser/parsertests.js?r=86
		// http://code.google.com/p/es-lab/source/browse/trunk/test/parser/parsertests.js?r=430

		// first test for the lexer, should also parse as program (when you append a semi)
		...
		// program test (for as far as they havent been covered above)
		...
		// test from http://es5conform.codeplex.com/
