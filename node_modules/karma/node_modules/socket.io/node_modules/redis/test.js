...
// Set test were adapted from Brian Hammond's redis-node-client.js, which has a comprehensive test suite
...
run_next_test = function run_next_test() {
    ...
    if (typeof tests[test_name] === "function") {
        ...
        console.log('\n  completed \x1b[32m%d\x1b[0m test in \x1b[33m%d\x1b[0m ms\n', test_count, new Date() - all_start);
        client.quit();
        client2.quit();
    }
};
