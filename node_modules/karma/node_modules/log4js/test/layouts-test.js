...
vows.describe('log4js layouts').addBatch({
  ...
  'basicLayout': {
    ...
    'should take a logevent and output a formatted string': function(args) {
      ...
      assert.equal(layout(event), "[2010-12-05 14:18:30.045] [DEBUG] test - this is a test");
    },
    'should output a stacktrace, message if the event has an error attached': function(args) {
      ...
      assert.equal(
        lines[0],
        "[2010-12-05 14:18:30.045] [DEBUG] test - this is a test [Error: Some made-up error]"
      );
    ...
    'should output any extra data in the log event as util.inspect strings': function(args) {
      ...
      assert.equal(
        output,
        "[2010-12-05 14:18:30.045] [DEBUG] test - this is a test " +
  ...
  'patternLayout': {
    ...
    'should default to "time logLevel loggerName - message"': function(args) {
      test(args, null, "14:18:30 DEBUG multiple.levels.of.test - this is a test" + EOL);
    },
    ...
    'should handle complicated patterns': function(args) {
      test(args,
           ...
           'this is a test'+ EOL +' of.test at 14:18:30.045 cheese DEBUG' + EOL
          );
    },
