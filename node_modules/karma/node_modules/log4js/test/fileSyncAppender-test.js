  ...
  'configure' : {
    'with fileSyncAppender': {
      topic: function() {
        ...
        , logger;
        //this config defines one file appender (to ./tmp-sync-test.log)
        //and sets the log level for "test" to WARN
        log4js.configure({
            appenders: [{ 
                category: "tests", 
                type: "file", 
                filename: "tmp-sync-test.log",
        ...
        fs.readFile('tmp-sync-test.log', 'utf8', this.callback);
      },
