...
// The browser is ready to execute test.
var READY = 1;

// The browser is executing the test/
var EXECUTING = 2;

// The browser is not executing, but temporarily disconnected (waiting for reconnecting).
var READY_DISCONNECTED = 3;

// The browser is executing the test, but temporarily disconnect (waiting for reconnecting).
